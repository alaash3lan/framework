...
{  
     ...
     * @return false/string
     */
    public static function required(string $key,string $value)
    {
        if (!strlen($value) == 0){
            return false;
        }
     ...
     * @return false/string
     */
    public static function numeric(string $key,string $value)
    {
        if (is_numeric($value)){
            return false;
        }
     ...
     * @return false/string
     */
    public static function max(string $key,string $value,$num)
    {
        if (strlen($value) < $num){
            return false;
        }
     ...
     * @return false/string
     */
    public static function min(string $key,string $value,$num)
    {
        if (strlen($value) >= $num){
            return false;
        }
     ...
     * @return false/string
     */
    public static function email(string $key ,string $str)
    {
